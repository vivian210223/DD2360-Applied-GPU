...
#ifdef UM
  cudaMallocManaged((void**)&new, (unsigned) (n * sizeof (float)), cudaMemAttachGlobal);
#else
...
int m, n;
{
  ...
  float **new;
#ifdef UM
  cudaMallocManaged((void**)&new,(unsigned) (m * sizeof (float*)), cudaMemAttachGlobal);
#else
...
#ifdef UM
  cudaMallocManaged(&newnet, sizeof(BPNN), cudaMemAttachGlobal);
#else
